...
import static edu.uwm.apc430.Card.Rank.TEN;
...
import edu.uwm.apc430.Card.Rank;
import edu.uwm.apc430.Card.Suit;
...
public class TestCard extends LockedTestCase {
	...
	public void test() {
		// c is array with 0=null, 1=A♦, 2=2♦, 3=K♦, 4=2♣, 5=K♥, 6=10♥, 7=A♠
		// cards print as [RANK] of [SUIT]S, e.g. KING of DIAMONDS
