...
public class TestDuration extends LockedTestCase {
	...
	public void test17() {
		assertFalse(Duration.INSTANTANEOUS.equals(0));
		assertFalse(Duration.MILLISECOND.equals(1));
	}
	...
	public void test20() {
		...
		assertEquals(Duration.INSTANTANEOUS, zero);
	}
	...
	public void test23() {
		assertEquals(Duration.HOUR, Duration.SECOND.scale(3600));
	}
	
	public void test24() {
		assertEquals(Duration.MILLISECOND, Duration.SECOND.scale(0.001));
	}
	
	public void test25() {
		assertEquals(Duration.YEAR, Duration.HOUR.scale(8766));
	}
	...
	public void test33() {
		...
		assertEquals(Duration.SECOND, d);
	}
